  ...
  <div class="modal waiting-location-selection" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <div class="modal-body">
      <div class="row-fluid">
        <div class="span12">
          <div class="well">
          <p>Waiting for <span class="make-bold"><?php echo $request_user['Name']; ?> <?php echo $request_user['Surname']; ?></span> to pick a place to meet halfway</p>
    ...
    <div class="modal-footer">
      <button class='btn btn-danger' onclick="confirm_venue_choice(<?php echo $match['Match_Id']; ?>)">Cancel Request</button>
    </div>
  </div>
</div>
